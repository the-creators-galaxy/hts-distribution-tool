        ...
        describe('method loadAndParseCsvDistributionFile', function () {
            ...
            describe('loads valid file without errors and', function () {
                ...
                it('generates a transfer list', function () {
                    ...
                    expect(data.transfers.find(t => t.account.toString() === '0.0.3107592')).to.have.property('amount').with.to.satisfy(a => a.toString() === '819.23610931');
                    expect(data.transfers.find(t => t.account.toString() === '0.0.3107612')).to.have.property('amount').with.to.satisfy(a => a.toString() === '7608.88793741');
                    expect(data.transfers.find(t => t.account.toString() === '0.0.3107603')).to.have.property('amount').with.to.satisfy(a => a.toString() === '4988.42042225');
                });
            ...
            describe('loads parsable file with errors and', function () {
                ...
                it('generates a transfer list', function () {
                    ...
                    // Spot Check some of the transfers, but not all
                    expect(data.transfers.find(t => t.account.toString() === '0.0.3107592')).to.have.property('amount').with.to.satisfy(a => a.toString() === '819.23610931');
                    expect(data.transfers.find(t => t.account.toString() === '0.0.3107593')).to.have.property('amount').with.to.satisfy(a => a.toString() === '4793.09818506');
                    expect(data.transfers.find(t => t.account.toString() === '0.0.3107608')).to.have.property('amount').with.to.satisfy(a => a.toString() === '3712.39027706');
                    expect(data.transfers.find(t => t.account.toString() === '0.0.3107616')).to.have.property('amount').with.to.satisfy(a => a.toString() === '5652.41249923');
                });
                it('orders transfer list by account id first', function () {
                    for (let i = 1; i < data.transfers.length; i++) {
                        const lhs = data.transfers[i - 1];
